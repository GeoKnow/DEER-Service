...
public class GeoLiftRun extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isCompletePath == 2) {
            ...
            args[1] = uploadFilePath + "generator" + File.separator + "uploads" + File.separator
                    + input;
        }
    ...
    public static void ExecuteGeoLift(String args[]) throws IOException {
        ...
        System.out.println("java -jar \"" + filePath + "WEB-INF" + File.separator + "lib"
                + File.separator + "geolift-0.4.jar\" -i " + args[1] + " -c " + args[3] + " -o "
                + args[5]);
        Process proc = Runtime.getRuntime().exec(
                "java -jar " + filePath + "WEB-INF" + File.separator + "lib" + File.separator
                        + "geolift-0.4.jar -i " + args[1] + " -c " + args[3] + " -o " + args[5]);
